...
* Tested with Wordpress 3.8.2 through to 4.4 , WooCommerce version 2.0.20 through to 2.4.12
...
== Changelog ==
= 1.0.7 =
* Fixed deprecated get_shipping_address() function issue
...
= 1.0.5 =
* Tested with WordPress 4.2.1 and WooCommerce 2.3.7
